...
## **6. Защита кода приложений**

Для защиты данных при использовании внедрить применение: Обфускаторы или компиьяторы в исполняемый неинтерпретируемый код.

В зависимости от языка, обфускатор. Создание binary сборок, которые сложно подвергнуть реверсинжинирингу.
